...
Inspecting the database reveals a very interesting “users” table containing password hashes for two users, one of which belongs to the **engineer** user we identified before, this is the most valuable piece of information we have found so far. 
